...
::: {.callout-important title="O Escudo Protetor da Informalidade"}
Como **40,5% dos trabalhadores brasileiros são informais**, a ausência de capital organizacional nas firmas atua como escudo protetor para trabalhadores de baixa qualificação contra o deslocamento corporativo por IA. **35,7 milhões de trabalhadores (35%)** ocupam postos com exposição quase nula ($\theta \le 2$), predominantemente na agricultura de subsistência, serviços domésticos informais e cuidados pessoais.
:::
:::
...
**Graduando em Economia — Universidade de Coimbra**

Este é um projeto de portfólio em microeconomia aplicada que analisa como a informalidade estrutural molda a transição tecnológica em economias emergentes. Desenvolve um modelo formal de designação ocupacional com dupla adoção de IA (individual e corporativa), vinculado deterministicamente a microdados oficiais da pesquisa domiciliar brasileira.
