...
Por supermodularidade estrita [@topkis1998supermodularity], a alocação de equilíbrio $\theta^*(e)$ é monotonicamente crescente em $e$: $\beta_1 > 0$.
:::
...
- **S2 (Controle de Rendimento):**
  $$\theta_{j(i)} = \alpha + \beta_1 \, e_i + \beta_{\text{sal}} \, w_i + \mathbf{X}_i'\boldsymbol{\gamma} + \varepsilon_i$$
:::

::: {.column width="48%"}
**Mecanismos e Espaço:**

- **S3 (Mediação da Informalidade):**
...
- **S2 com Salário:** $\hat{\beta}_1 = \mathbf{0{,}21}$ (EP $0{,}026$); Rendimento: $\hat{\beta}_{\text{sal}} = \mathbf{0{,}043}$ ($p < 0{,}001$).
