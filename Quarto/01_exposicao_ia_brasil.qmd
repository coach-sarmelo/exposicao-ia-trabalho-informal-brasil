...
- [**35,7 milhões de trabalhadores (35,0%)**]{.emorygold} em ocupações de baixíssima exposição à IA ($\theta_j \le 2$).
...
Erros-padrão agrupados por [**122 clusters ocupacionais**]{.emorygold} (Cameron, Gelbach e Miller, 2008).
:::
...
- [**37,2% Atenuação**]{.emorygold}: Explicada pela seleção educacional em tarefas cognitivas.
- [**62,8% Efeito Direto**]{.emorygold}: Atribuível a governança, escala de dados e capital organizacional ($\Delta\kappa > 0$).
:::
:::
