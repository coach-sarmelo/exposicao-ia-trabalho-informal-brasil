# AGENTS.md -- Academic & Empirical Research with Antigravity
...
├── .agents/                          # 18 agents, 52 skills, 33 rules, 7 hooks
...
```bash
# Run complete canonical R data & econometric pipeline
Rscript scripts/R/00_run_all.R

# Run R econometric verification suite
Rscript scripts/R/test_econometrics.R

# Run dual-engine Python pipeline & cross-validation tests
...
| Component | Target File | Status | Key Content |
|-----------|-------------|--------|-------------|
| **Data Pipeline** | `data/scripts/run_all.py` | Operational | 13-step ETL (IBGE PNAD Contínua microdata, COD-SOC-O*NET crosswalk, AI exposure) |
| **Econometrics** | `data/scripts/compute_econometrics.py` | Operational | WLS gradient, informality mediation, regional panel models, logit regressions |
| **Academic Paper** | `paper/main.tex` | Operational | 7 sections: theoretical model, data, empirical strategy, results, appendix |
| **Figures** | `paper/figures/fig1_gradiente` | Operational | Education vs AI Exposure (WLS beta = 0.23, SE 0.03) |
| **Figures** | `paper/figures/fig2_mediacao` | Operational | Informality rate vs AI exposure (Gross vs partial mediation) |
| **Figures** | `paper/figures/fig3_regional_slopes` | Operational | Heterogeneity across 5 Brazilian macro-regions |
| **Figures** | `paper/figures/fig5_robustez_forest` | Operational | Forest plot across occupation exclusions and weighting |
