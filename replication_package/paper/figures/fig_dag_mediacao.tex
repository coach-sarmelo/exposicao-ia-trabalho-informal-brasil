...
% 2. Canal direto hipotético (organizacional) — 62,8% do coeficiente retido;
%    não separável de outros atributos ocupacionais no desenho transversal
%
...
\begin{tikzpicture}
  ...
  \draw[direct-edge] (X) to[bend right=28]
    node[midway, below=0.35cm, align=center, font=\footnotesize] {
      \textcolor{direct-red}{\textbf{Hipótese (não estimada): canal organizacional}}\\[0.15em]
      $\hat{\delta}_1 = -3{,}91^{***}$ p.p. (EP 0{,}96) \quad $\big[62{,}8\%$ do coeficiente retido$\big]$\\[0.15em]
