...
\begin{equation}
    \Delta = \big(\kappa_{\text{org}}\theta_H - \kappa_{\text{ind}}\theta_L\big)\big[g(e_H) - g(e_L)\big]
    + \big[g(e_H)\Delta\kappa\theta_L - c\big]_+ > 0,
\end{equation}
...
\begin{equation}
    \frac{\partial^3 w^*}{\partial e \, \partial \theta_j \, \partial \Delta\kappa_u} = g'(e) \, \mathbb{1}[e \ge e_{ju}^*]
    - g'(e)\Delta\kappa_u \, \delta(e - e_{ju}^*) \, \frac{\partial e_{ju}^*}{\partial \Delta\kappa_u} > 0,
\end{equation}
