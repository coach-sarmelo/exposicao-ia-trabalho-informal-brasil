...
def test_cod_subgroups_national():
    json_path = os.path.join(os.path.dirname(__file__), '../output/cod_subgroups.json')
...
def test_cod_subgroups_by_uf():
    json_path = os.path.join(os.path.dirname(__file__), '../output/cod_subgroups_by_uf.json')
