    ...
    \begin{columns}[T]
        \begin{column}{0.56\textwidth}
            ...
            \begin{itemize}
                ...
                de baixíssima exposição à IA ($\theta_j \le 2$).
...
\begin{frame}{Arbitragem Formal-Informal e Previsões Teóricas}
    \begin{columns}[T]
        \begin{column}{0.50\textwidth}
            ...
            \begin{itemize}
                \item Ocupações com maior $\theta_j$ reduzem a exigência
                educacional para a formalidade corporativa.
            \end{itemize}
        \end{column}
        ...
        \begin{column}{0.46\textwidth}
            \begin{block}{Proposição 1 (Gradiente Positivo)}
                ...
                equilíbrio $\theta^*(e)$ é crescente em $e$: $\beta_1 > 0$.
            \end{block}
        ...
        \begin{column}{0.50\textwidth}
            ...
            \begin{block}{Limiar Crítico de Polarização: $e^* = 11{,}14$ anos}
                \begin{itemize}
                    ...
                    $\frac{\partial \theta}{\partial \text{formal}_u} = \mathbf{-0{,}86}$ pt.
                    \item $e_i = 16$ anos (Sup.):
                    $\frac{\partial \theta}{\partial \text{formal}_u} = \mathbf{+1{,}38}$ pt.
                \end{itemize}
            \end{block}
        \end{column}
