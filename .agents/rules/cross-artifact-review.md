...
- `.agents/plugins/academic-workflow/skills/review-paper/SKILL.md` — the orchestrator.
- `.agents/plugins/academic-workflow/skills/review-r/SKILL.md` — code reviewer.
- `.agents/plugins/academic-workflow/skills/audit-reproducibility/SKILL.md` — numeric claims verifier.
- `.agents/plugins/academic-workflow/rules/replication-protocol.md` — tolerance contract.
