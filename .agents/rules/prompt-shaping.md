...
Full elaboration and examples: [`.agents/plugins/academic-workflow/references/prompt-formatting-core.md`](../references/prompt-formatting-core.md).
...
- [`.agents/plugins/academic-workflow/references/prompt-formatting-core.md`](../references/prompt-formatting-core.md) — the six-section elaboration.
- [`.agents/plugins/academic-workflow/skills/interview-me/SKILL.md`](../skills/interview-me/SKILL.md) — multi-turn specification (the surviving, heavier sibling).
- [`.agents/plugins/academic-workflow/rules/plan-first-workflow.md`](plan-first-workflow.md) — for non-trivial tasks, shaping feeds the plan.
