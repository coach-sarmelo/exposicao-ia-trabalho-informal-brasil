...
- **INV-6: No `\pause` or overlays.** Beamer `\pause`, `\only`, `\visible`, `\onslide` commands are forbidden. See `.agents/plugins/academic-workflow/rules/no-pause-beamer.md` for rationale.
