...
## Cross-references
- [`.agents/plugins/academic-workflow/skills/did-event-study/SKILL.md`](../skills/did-event-study/SKILL.md) — the pipeline.
- [`.agents/plugins/academic-workflow/rules/replication-protocol.md`](replication-protocol.md) · [`.agents/plugins/academic-workflow/rules/r-code-conventions.md`](r-code-conventions.md) · [`.agents/plugins/academic-workflow/rules/simulation-conventions.md`](simulation-conventions.md).
