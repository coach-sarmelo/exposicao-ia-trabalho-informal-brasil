...
- [stata-mcp on GitHub](https://github.com/SepineTam/stata-mcp) — the MCP server that lets Antigravity (agy) execute Stata `.do` files. Install via `claude mcp add stata-mcp --scope user -- uvx stata-mcp`.
