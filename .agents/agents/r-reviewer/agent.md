...
2. **Read `.agents/plugins/academic-workflow/rules/r-code-conventions.md`** for the current standards
...
- [ ] Check `.agents/plugins/academic-workflow/rules/r-code-conventions.md` for known pitfalls
...
5. **Check Known Pitfalls.** See `.agents/plugins/academic-workflow/rules/r-code-conventions.md` for project-specific bugs.
