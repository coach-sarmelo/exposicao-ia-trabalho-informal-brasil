...
`Bibliography_base.bib` at repo root by default; override via AGENTS.md / GEMINI.md.
...
- `.agents/plugins/academic-workflow/skills/review-paper/SKILL.md` — pair for full pre-submission.
- `.agents/plugins/academic-workflow/skills/audit-reproducibility/SKILL.md` — numeric-claims counterpart.
- `.agents/plugins/academic-workflow/skills/verify-claims/SKILL.md` — citation **appropriateness** counterpart (does the cited paper support the claim?). This skill checks that a citation *exists and is well-formed*; `/verify-claims` checks that it *holds*.
