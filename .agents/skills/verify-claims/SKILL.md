...
Fact-check a draft using the **Post-Flight Verification protocol** ([`.agents/plugins/academic-workflow/rules/post-flight-verification.md`](../../rules/post-flight-verification.md)).
...
- `claim-verifier` agent file exists at `.agents/plugins/academic-workflow/skills/claim-verifier.md`
...
- [`.agents/plugins/academic-workflow/skills/claim-verifier.md`](../../agents/claim-verifier.md) — the forked verifier.
- [`.agents/plugins/academic-workflow/rules/post-flight-verification.md`](../../rules/post-flight-verification.md) — the protocol.
