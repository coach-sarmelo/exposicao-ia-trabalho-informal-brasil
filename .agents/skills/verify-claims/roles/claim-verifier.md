...
- `.agents/plugins/academic-workflow/rules/post-flight-verification.md` — the protocol callers follow.
- `.agents/plugins/academic-workflow/skills/verify-claims/SKILL.md` — user-facing wrapper.
