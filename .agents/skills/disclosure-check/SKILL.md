...
1. Read [`.agents/plugins/academic-workflow/rules/confidential-data.md`](../../rules/confidential-data.md) for the project's restricted-data handling contract and the rule-profile placeholder.
...
- [`.agents/plugins/academic-workflow/rules/confidential-data.md`](../../rules/confidential-data.md) — restricted-data handling contract + the provider-rule profiles this skill loads.
- [`.agents/plugins/academic-workflow/rules/replication-protocol.md`](../../rules/replication-protocol.md) — for restricted-data papers the replication package ships code + access path, not the microdata; screen every released output first.
- [`.agents/plugins/academic-workflow/skills/audit-reproducibility/SKILL.md`](../audit-reproducibility/SKILL.md) — numeric paper↔code verification: run it on the *retained* values, this skill on the *released* ones.
- [`.agents/plugins/academic-workflow/skills/data-analysis/SKILL.md`](../data-analysis/SKILL.md), [`.agents/plugins/academic-workflow/skills/stata-replication/SKILL.md`](../stata-replication/SKILL.md) — produce the R / Stata / Python outputs this skill screens.
