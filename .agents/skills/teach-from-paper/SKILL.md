...
- `/create-lecture` — consumes the Phase 2 slide skeleton to draft the actual Beamer deck. See [`.agents/plugins/academic-workflow/skills/create-lecture/SKILL.md`](../create-lecture/SKILL.md).
- `/review-paper` — referee the paper's correctness *before* teaching it if you're unsure the result holds. See [`.agents/plugins/academic-workflow/skills/review-paper/SKILL.md`](../review-paper/SKILL.md).
- `/lit-review` — for situating the paper among many, rather than teaching one deeply. See [`.agents/plugins/academic-workflow/skills/lit-review/SKILL.md`](../lit-review/SKILL.md).
