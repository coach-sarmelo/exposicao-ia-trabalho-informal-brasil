...
ls .agents/plugins/academic-workflow/skills/ 2>/dev/null

# Search for keywords
grep -r -i "KEYWORD" .agents/plugins/academic-workflow/skills/ 2>/dev/null
```
...
Create the skill file at `.agents/plugins/academic-workflow/skills/[skill-name]/SKILL.md`:
...
```
✓ Skill created: .agents/plugins/academic-workflow/skills/[name]/SKILL.md
  Trigger: [when to use]
