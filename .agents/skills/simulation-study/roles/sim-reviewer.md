...
2. **Read [`.agents/plugins/academic-workflow/rules/simulation-conventions.md`](../rules/simulation-conventions.md)** for the standard, and skim [`r-reviewer.md`](r-reviewer.md) Cat 9 + Cat 11 so you don't duplicate them.
