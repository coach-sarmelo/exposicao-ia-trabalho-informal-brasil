...
Produce a Data Management Plan ready to paste into a funder portal. This skill writes the prose and structure; it does **not** submit anywhere. It is a **composition** skill — it folds the disclosure-avoidance / IRB rules from [`.agents/plugins/academic-workflow/rules/confidential-data.md`](../../rules/confidential-data.md) and the environment + replication-package plan from `/capture-environment` and `/replication-package` into a single funder-shaped document.
...
Pull the relevant rules from [`.agents/plugins/academic-workflow/rules/confidential-data.md`](../../rules/confidential-data.md) and weave them into the **access & sharing** and **preservation** sections:
...
- [`.agents/plugins/academic-workflow/rules/confidential-data.md`](../../rules/confidential-data.md) — restricted-data / IRB / disclosure-avoidance rules folded in at Phase 2.
- `.agents/plugins/academic-workflow/skills/disclosure-check/SKILL.md` — pre-release disclosure scan the plan commits released outputs to.
- `.agents/plugins/academic-workflow/skills/capture-environment/SKILL.md` — the environment-capture mechanism Phase 3 references.
- `.agents/plugins/academic-workflow/skills/replication-package/SKILL.md` — the replication-package builder Phase 3 commits to.
- `.agents/plugins/academic-workflow/skills/grant-proposal/SKILL.md` — calls this skill for the proposal's data-management section.
- [`.agents/plugins/academic-workflow/skills/preregister/SKILL.md`](../preregister/SKILL.md) — sibling document-generator; shares the MUST/`[CLARIFY:]` + post-flight conventions.
- [`.agents/plugins/academic-workflow/rules/replication-protocol.md`](../../rules/replication-protocol.md) — the reproducibility contract the deposited package must satisfy.
