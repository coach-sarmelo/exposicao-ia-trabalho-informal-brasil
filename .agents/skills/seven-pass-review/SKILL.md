...
- `.agents/plugins/academic-workflow/skills/review-paper/SKILL.md` — the single-pass and `--adversarial` modes (cheaper, faster).
- `.agents/plugins/academic-workflow/skills/validate-bib/SKILL.md` — invoked by Lens 7.
- `.agents/plugins/academic-workflow/skills/audit-reproducibility/SKILL.md` — complementary; numeric-claims side of the audit.
