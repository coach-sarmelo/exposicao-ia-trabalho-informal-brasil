...
- **Follow R code conventions** in `.agents/plugins/academic-workflow/rules/r-code-conventions.md`
...
- **Use project theme** for all figures (check for custom theme in `.agents/plugins/academic-workflow/rules/`)
...
- `.agents/plugins/academic-workflow/rules/r-code-conventions.md` — [one-line summary of most relevant rule]
- `.agents/plugins/academic-workflow/rules/content-invariants.md` — [INV-9, INV-10, INV-11, INV-12 applicable]
