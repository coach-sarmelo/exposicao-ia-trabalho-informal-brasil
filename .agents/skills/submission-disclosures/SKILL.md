...
Interview briefly (or infer from the repo when evident — e.g. `quality_reports/`, session logs, a AGENTS.md / GEMINI.md):

- **Which tools** (Antigravity (agy), Copilot, ChatGPT, Grammarly-class) and **for what**: writing/editing prose, code authoring, code review, literature search, data analysis, translation.
...
- [`.agents/plugins/academic-workflow/skills/disclosure-check/SKILL.md`](../disclosure-check/SKILL.md) — statistical-disclosure screening of restricted-data outputs (the other "disclosure"; unrelated).
- [`.agents/plugins/academic-workflow/skills/replication-package/SKILL.md`](../replication-package/SKILL.md) — the deposit the data-availability statement must match.
- [`.agents/plugins/academic-workflow/references/journal-profiles.md`](../../references/journal-profiles.md) — per-journal calibration, incl. the AEA DCAS policy note.
- [`.agents/plugins/academic-workflow/rules/confidential-data.md`](../../rules/confidential-data.md) — restricted-data constraints on what the statements can say.
- [`.agents/plugins/academic-workflow/skills/humanize/SKILL.md`](../humanize/SKILL.md) — detecting AI-voice in prose; disclosure and voice are separate obligations.
