...
- `.agents/agents/editor.md` — reads this file.
- `.agents/agents/domain-referee.md` — applies domain-referee adjustments.
- `.agents/agents/methods-referee.md` — applies methods-referee adjustments.
- `.agents/plugins/academic-workflow/skills/review-paper/SKILL.md` — `--peer [journal]` mode entry point.
