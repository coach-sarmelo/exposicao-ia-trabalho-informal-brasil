...
- **File:** `.agents/plugins/academic-workflow/references/discipline-cards.md`
- **Schema parallel:** `.agents/plugins/academic-workflow/references/journal-profiles.md` (per-journal) and `.agents/plugins/academic-workflow/references/audit-pet-peeves.md` (living-catalogue format).
