...
- [`.agents/hooks/claim-reconcile.py`](../hooks/claim-reconcile.py) — the event-driven reconciliation hook.
- [`.agents/plugins/academic-workflow/rules/replication-protocol.md`](../rules/replication-protocol.md) — what the reproducibility routine checks.
- [`.agents/plugins/academic-workflow/rules/confidential-data.md`](../rules/confidential-data.md) — why unattended runs stay human-gated near restricted data.
