...
## Python Dependencies (Verification Engine)
...
1. `scripts/R/_outputs/sessionInfo.txt` — Full human-readable R session capture.
2. `replication_package/output/sessionInfo.txt` — Standalone replication deposit session log.
3. `requirements.txt` — Python dual-engine dependencies.
